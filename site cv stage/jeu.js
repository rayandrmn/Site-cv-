...
let spami = document.getElementById("spami");

function spam(){
    for (let spam = 0; spam < 1000; spam++) {
       
       inputnom = "cc";
       inputemail = "rayan.drmn@gmail.com";
       textarea = 'cc';
...
let textarea = document.getElementById("formText").value;
let inputnom = document.getElementById("name").value;
let inputemail = document.getElementById("email").value;
let inputobjet = document.getElementById("objet").value;
 

let spami = document.querySelector("button");
spami.setAttribute("id", "cliqueomg");
